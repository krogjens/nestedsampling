...
info.misc.labels={'Model check for information with scaling n:'...
;' Scaling n:'... % Note: if this line is deleted then ' Input:  ' is printed
};
...
stepcor.misc.labels={'Model check for estimated n-step correlations:'...
...
stepdist.misc.labels={'Model check with p-values for percentiles (C) for n-step (R) distributions:'...
