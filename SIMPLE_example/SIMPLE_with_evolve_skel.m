function SIMPLE_with_evolve_skel()
...
models(1).u_evolve=@(u,du) u+du;
models(2).u_evolve=@(u,du) u+du;;
models(1).evolver=@ns_evolve_exp;
models(2).evolver=@ns_evolve_rectangle;
